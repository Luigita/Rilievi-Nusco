...
class RilievoTapparella {
  ...
  factory RilievoTapparella.fromMap(Map<String, dynamic> json) =>
      RilievoTapparella(
        ...
        larghezzaInfissi: json['larghezzaInfissi'].toString(),
        altezzaInfissi: json['altezzaInfissi'].toString(),
...
class Configurazione {
  ...
  int? larghezzaLuce;
  int? altezzaLuce;
  int? larghezzaCassonetto = 0;
  int? altezzaCassonetto = 0;
  int? spessoreCassonetto = 0;
  int? profonditaCielino = 0;
  String? note;
  String? blob;
  String? disegno;
  String? audioVideo;
...
class DBHelper {
  ...
  Future _onCreate(Database db, int version) async {
    ...
    await db.execute('''
      CREATE TABLE configurazioneTapparelle(
        ...
        larghezzaLuce INT,
        altezzaLuce INT,
        larghezzaCassonetto INT,
        altezzaCassonetto INT,
        spessoreCassonetto INT,
        profonditaCielino INT,
        note STRING,
        idParente STRING,        
        disegno STRING,
        audioVideo STRING,
  ...
  Future<List<String>> exportDatabase() async {
    ...
    encoder.addFile(File('$path/rilievi.db'));
